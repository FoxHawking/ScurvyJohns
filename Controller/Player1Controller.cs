...
/// <summary>
/// Player1Controller controls player 1
/// </summary>
public class Player1Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Input.GetKey(KeyCode.D)) && (Ground || Wall))
        {
            ...
            else if (Input.GetKeyDown(KeyCode.Space)) //Spacebar (jump action)
            {
                //if Touching ground
                if (Ground)
                {
        ...
        else if (Input.GetKey(KeyCode.A) && (Ground || Wall))
        {
